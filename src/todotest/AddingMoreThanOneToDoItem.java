...
public class AddingMoreThanOneToDoItem {
	...
	@Test				
	public void AddingMoreThanOneToDoItemTest() throws Exception {
		...
		driver.findElement(By.id("new-todo")).sendKeys(Keys.ENTER);
		Thread.sleep(1500);
		driver.findElement(By.id("new-todo")).sendKeys("I have to do Sleep for 7 hours");
		driver.findElement(By.id("new-todo")).sendKeys(Keys.ENTER);
